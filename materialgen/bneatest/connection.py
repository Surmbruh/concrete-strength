...
class Connection(object):
    ...
    def __init__(self, in_node: Node, out_node: Node, innovation: int = -1,
                 ...
                 weight: BayesianWeight = None, dummy: bool = False):
        ...
        self.weight = weight if weight is not None else BayesianWeight(1.0)
        if not dummy:
    ...
    def __str__(self):
        ...
        string = f'{string}Weight: mu={self.weight.mu.item():.3f} sigma={self.weight.sigma.item():.3f} '
